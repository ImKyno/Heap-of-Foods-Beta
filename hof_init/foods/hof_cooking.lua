...
AddIngredientValues({"succulent_picked"}, 		{veggie     = 0.25, foliage   = 1})
...
AddIngredientValues({"kyno_jellyfish"},         {meat       = 0.5,  fish      = 0.5,  jellyfish = 1},   true, true)
AddIngredientValues({"kyno_jellyfish_dead"},    {meat       = 0.5,  fish      = 0.5,  jellyfish = 1})
