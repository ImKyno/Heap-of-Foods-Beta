...
AddNewVeggie("kyno_radish", 1, 12.5, 0, TUNING.PERISH_MED, 3, 12.5, 0, TUNING.PERISH_FAST, TUNING.SEED_CHANCE_COMMON)
AddNewVeggie("kyno_cucumber", 1, 12.5, -5, TUNING.PERISH_MED, nil, nil, nil, nil, TUNING.SEED_CHANCE_COMMON)
AddNewVeggie("kyno_sweetpotato", 1, 12.5, 0, TUNING.PERISH_MED, 3, 12.5, 0, TUNING.PERISH_FAST, TUNING.SEED_CHANCE_UNCOMMON)
AddNewVeggie("kyno_parznip", 1, 6, 0, TUNING.PERISH_MED, 3, 18.5, 1, TUNING.PERISH_FAST, TUNING.SEED_CHANCE_UNCOMMON)
...
PLANT_DEFS.kyno_aloe.sounds = PLANT_DEFS.dragonfruit.sounds
...
PLANT_DEFS.kyno_cucumber.sounds = PLANT_DEFS.dragonfruit.sounds
...
PLANT_DEFS.kyno_parznip.sounds = PLANT_DEFS.eggplant.sounds
...
PLANT_DEFS.kyno_turnip.sounds = PLANT_DEFS.eggplant.sounds
