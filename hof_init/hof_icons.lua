...
if _G.TheNet:GetIsMasterSimulation() then
	...
	"kyno_coffeebeans_cooked", "kyno_coffeebeans", "dug_kyno_coffeebush", "kyno_shark_fin", "kyno_roe_cooked", "kyno_roe", 
	...
	"kyno_bacon_cooked", "gorge_bread", "gorge_potato_chips", "gorge_vegetable_soup", "gorge_jelly_sandwich", "gorge_fish_stew", "gorge_meat_stew", "gorge_onion_cake",
	...
	"gorge_scone", "gorge_trifle", "gorge_cheesecake", "robin_winter", "gears", "rocks", "petals", "foliage", "rabbit", "rabbit_winter", "beard_monster", "succulent_picked", "dug_kyno_spotbush", "kyno_spotspice_leaf",
	...
	"kyno_cucumber_seeds", "cucumbersalad", "kyno_waterycress", "waterycressbowl", "kyno_salt", "kyno_parznip", "kyno_parznip_cooked", "kyno_parznip_eaten", "kyno_parznip_seeds",
	"kyno_radish_oversized", "kyno_radish_oversized_waxed", "kyno_sweetpotato_oversized", "kyno_sweetpotato_oversized_waxed", "kyno_fennel_oversized", "kyno_fennel_oversized_waxed",
	"kyno_aloe_oversized", "kyno_aloe_oversized_waxed", "kyno_cucumber_oversized", "kyno_cucumber_oversized_waxed", "kyno_parznip_oversized", "kyno_parznip_oversized_waxed",
	"kyno_turnip", "kyno_turnip_cooked", "kyno_turnip_seeds", "kyno_turnip_oversized", "kyno_turnip_oversized_waxed", "festive_berrysauce", "festive_bibingka", "festive_cabbagerolls",
	"festive_fishdish", "festive_goodgravy", "festive_latkes", "festive_lutefisk", "festive_mulledpunch", "festive_panettone", "festive_pavlova", "festive_pickledherring", "festive_polishcookies",
	"festive_pumpkinpie", "festive_roastedturkey", "festive_stuffing", "festive_sweetpotato", "festive_tamales", "festive_tourtiere", "kyno_musselstick_item", "catfood", "katfood", "kyno_banana",
	...
	"kyno_beancan_open", "kyno_meatcan", "kyno_meatcan_open", "kyno_sodacan", "kyno_cokecan", "kyno_energycan", "kyno_bottle_soul", "soulstew", "fortunecookie", "kyno_milk_beefalo", "kyno_milk_koalefant", 
	"kyno_milk_deer", "kyno_bucket_empty", "kyno_bucket_milk", "kyno_bucket_water", "hornocupia", "kyno_brewbook", "beer"}) do
