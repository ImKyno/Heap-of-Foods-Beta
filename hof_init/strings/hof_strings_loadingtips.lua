...
AddLoadingTip(TIPS_HOF, "TIPS_HOF_MILKABLEANIMALS", "Some animals such as: Beefalos, Koalefants and No-Eyed Deers can be milked using the Bucket. Be careful, though!")
AddLoadingTip(TIPS_HOF, "TIPS_HOF_FORTUNECOOKIE",   "\"Do you really believe that stupid cookies tells your luck? Well, cause I don't!\" -W")
AddLoadingTip(TIPS_HOF, "TIPS_HOF_PINEAPPLEBUSH",   "Pineapples Bushes grows faster during the Summer.")
...
AddLoadingTip(TIPS_HOF, "TIPS_HOF_ACHIEVEMENTS",    "If you're using the Accomplishments Mod, you can find exclusive Accomplishments for the Heap of Foods! Can you get them all?")
