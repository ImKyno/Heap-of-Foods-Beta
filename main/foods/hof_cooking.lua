...
ModifyIngredientValues({"slurtle_shellpieces"},      {shell      = 1,    elemental  = 1,    inedible   = 1}, false, false, false)
...
ModifyIngredientValues({"gears"},                    {gears      = 1,    inedible   = 1},                    false, false, false)
ModifyIngredientValues({"rocks"},                    {elemental  = 1,    inedible   = 1},                    false, false, false)
ModifyIngredientValues({"poop"},                     {poop       = 1,    inedible   = 1},                    false, false, false)
ModifyIngredientValues({"guano"},                    {poop       = 1,    inedible   = 1},                    false, false, false)
ModifyIngredientValues({"glommerfuel"},              {poop       = 1,    inedible   = 1},                    false, false, false)
ModifyIngredientValues({"papyrus"},                  {paper      = 1,    roughage   = 1,    inedible   = 1}, false, false, false)
...
ModifyIngredientValues({"wagpunk_bits"},             {junk       = 1,    inedible   = 1},                    false, false, false)
...
ModifyIngredientValues({"townportaltalisman"},       {boss       = 1,    elemental  = 1,    inedible  = 1},  false, false, false)
...
AddIngredientValues({"kyno_kokonut_halved"},         {fruit      = 0.5})
AddIngredientValues({"kyno_kokonut_cooked"},         {fruit      = 0.5})
AddIngredientValues({"kyno_twiggynuts"},             {seeds      = 1,    fruit      = 0.25})
