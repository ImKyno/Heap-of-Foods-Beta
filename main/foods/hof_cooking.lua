...
AddIngredientValues({"foliage"},                     {veggie     = 0.25, foliage    = 1,    decoration = 1}, false, true)
...
AddIngredientValues({"moon_tree_blossom"},           {decoration = 1})
AddIngredientValues({"gears"},                       {gears      = 1})
AddIngredientValues({"rocks"},                       {elemental  = 1,    rock       = 1})
...
AddIngredientValues({"deerclops_eyeball"},           {boss       = 1})
AddIngredientValues({"bearger_fur"},                 {boss       = 1,    inedible   = 1})
...
AddIngredientValues({"potato"},                      {veggie     = 1,    potato     = 1},                    true, true)
