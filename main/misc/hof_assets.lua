...
Assets =
{
	...
	Asset("IMAGE", "images/hof_pigcoinvalue_icons.tex"),
	Asset("ATLAS", "images/hof_pigcoinvalue_icons.xml"),
...
local HOF_ICONS =
{
	...
	"sea_pudding",
	"seedsbag_aloe_seeds",
	"seedsbag_asparagus_seeds",
	"seedsbag_carrot_seeds",
	"seedsbag_corn_seeds",
	"seedsbag_cucumber_seeds",
	"seedsbag_dragonfruit_seeds",
	"seedsbag_durian_seeds",
	"seedsbag_eggplant_seeds",
	"seedsbag_fennel_seeds",
	"seedsbag_firenettles_seeds",
	"seedsbag_forgetmelots_seeds",
	"seedsbag_garlic_seeds",
	"seedsbag_icenettles_seeds",
	"seedsbag_onion_seeds",
	"seedsbag_parznip_seeds",
	"seedsbag_pepper_seeds",
	"seedsbag_pomegranate_seeds",
	"seedsbag_potato_seeds",
	"seedsbag_pumpkin_seeds",
	"seedsbag_radish_seeds",
	"seedsbag_rice_seeds",
	"seedsbag_sweetpotato_seeds",
	"seedsbag_tillweed_seeds",
	"seedsbag_tomato_seeds",
	"seedsbag_turnip_seeds",
	"seedsbag_unknown_seeds",
	"seedsbag_watermelon_seeds",
	"sharkfinsoup",
	"sharksushi",
	"slaw",
	"smores",
