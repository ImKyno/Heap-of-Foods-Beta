...
SortAfter("wx78module_cooker",                        "wx78module_stacksize",             "CHARACTER")
SortAfter("wx78module_cooker",                        "wx78module_digestion",             "COOKING")
SortAfter("wx78module_dryer",                         "wx78module_cooker",                "CHARACTER")
SortAfter("wx78module_dryer",                         "wx78module_cooker",                "COOKING")
SortAfter("wx78module_gourmand",                      "wx78module_dryer",                 "CHARACTER")
SortAfter("wx78module_gourmand",                      "wx78module_dryer",                 "COOKING")
SortAfter("wx78module_brewer",                        "wx78module_chess",                 "CHARACTER")
SortAfter("wx78module_brewer",                        "wx78module_gourmand",              "COOKING")
