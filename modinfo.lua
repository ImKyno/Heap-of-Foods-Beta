...
local STRINGS = 
{
	...
	NAME_BETA = 
	{
		...
		zht = "食物堆積 - 測試版分支 (Heap of Foods - Beta Branch)",
		pt  = "Amontoado de Comidas - Versão Beta (Heap of Foods - Beta Branch)",
