...
local options               =
{
	...
	language                = {{description = desc.language1,       hover = deschovers.language1,       data = false},         {description = desc.language2,       hover = deschovers.language2,       data = "pt"}, {description = desc.language3,       hover = deschovers.language3,       data = "zh"}}, 
