...
self:SetRegrowthForType("kyno_parznip_ground", TUNING.CARROT_REGROWTH_TIME, "kyno_parznip_ground", function()
        return not (_worldstate.isnight or _worldstate.iswinter or _worldstate.snowlevel > 0) and TUNING.CARROT_REGROWTH_TIME_MULT or 0
    end)
self:SetRegrowthForType("kyno_parznip_big", TUNING.CARROT_REGROWTH_TIME, "kyno_parznip_big", function()
        return not (_worldstate.isnight or _worldstate.iswinter or _worldstate.snowlevel > 0) and TUNING.CARROT_REGROWTH_TIME_MULT or 0
    end)
self:SetRegrowthForType("kyno_sugartree_flower", TUNING.FLOWER_REGROWTH_TIME, "kyno_sugartree_flower", function()
		return ((_worldstate.israining or _worldstate.isnight or _worldstate.iswinter or _worldstate.wetness <= 1 or _worldstate.snowlevel > 0) and 0)
            or (_worldstate.isspring and 2 * TUNING.FLOWER_REGROWTH_TIME_MULT)
            or TUNING.FLOWER_REGROWTH_TIME_MULT
    end)
--------------------------------------------------------------------------
--[[ Update ]]
