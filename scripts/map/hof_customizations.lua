...
{	
	...
	fennels         = {category = LEVELCATEGORY.WORLDGEN, desc = "worldgen_frequency_descriptions", group = "hof", order = 2,  world = {"forest", "cave"}},
	...
	islandcrates    = {category = LEVELCATEGORY.WORLDGEN, desc = "yesno_descriptions", group = "hof_meadow", order = 2,  world = {"forest"}},
	...
	mermhuts        = {category = LEVELCATEGORY.WORLDGEN, desc = "yesno_descriptions", group = "hof_meadow", order = 5,  world = {"forest"}},
	...
	-- WORLDSETTING
	mushstumps      = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions", group = "hof_r", order = 0,  world = {"forest", "cave"}},
	rockflippables  = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions", group = "hof_r", order = 1,  world = {"forest", "cave"}},
	wildwheats      = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions", group = "hof_r", order = 2,  world = {"forest"}},
	
	-- OCEANSETTING
	lotusplants     = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions", group = "hof_ocean_r", order = 1,  world = {"forest"}},
	oceancrates     = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions", group = "hof_ocean_r", order = 2,  world = {"forest"}},
	oceanwrecks     = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions", group = "hof_ocean_r", order = 3,  world = {"forest"}},
	taroroots       = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions", group = "hof_ocean_r", order = 4,  world = {"forest"}},
	waterycresses   = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions", group = "hof_ocean_r", order = 5,  world = {"forest"}},
	weedsea         = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions", group = "hof_ocean_r", order = 6,  world = {"forest"}},
	
	-- SERENITYSETTING
	chickens        = {category = LEVELCATEGORY.SETTINGS, desc = "frequency_descriptions", group = "hof_serenity_r", order = 0,  world = {"forest"}},
	pebblecrabs     = {category = LEVELCATEGORY.SETTINGS, desc = "frequency_descriptions", group = "hof_serenity_r", order = 1,  world = {"forest"}},
	saltponds       = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions",     group = "hof_serenity_r", order = 2,  world = {"forest"}},
	spotbushes      = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions",     group = "hof_serenity_r", order = 3,  world = {"forest"}},
	sugarflies      = {category = LEVELCATEGORY.SETTINGS, desc = "frequency_descriptions", group = "hof_serenity_r", order = 4,  world = {"forest"}},
	sugartrees      = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions",     group = "hof_serenity_r", order = 5,  world = {"forest"}},
	
	-- MEADOWSETTING
	fishermerms     = {category = LEVELCATEGORY.SETTINGS, desc = "frequency_descriptions", group = "hof_meadow_r", order = 0,  world = {"forest"}},
	kokonuttrees    = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions",     group = "hof_meadow_r", order = 1,  world = {"forest"}},
	limpetrocks     = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions",     group = "hof_meadow_r", order = 2,  world = {"forest"}},
	pikos           = {category = LEVELCATEGORY.SETTINGS, desc = "frequency_descriptions", group = "hof_meadow_r", order = 3,  world = {"forest"}},
	pikosorange     = {category = LEVELCATEGORY.SETTINGS, desc = "frequency_descriptions", group = "hof_meadow_r", order = 4,  world = {"forest"}},
	pineapplebushes = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions",     group = "hof_meadow_r", order = 5,  world = {"forest"}},
	sandhills       = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions",     group = "hof_meadow_r", order = 6,  world = {"forest"}},
	teatrees        = {category = LEVELCATEGORY.SETTINGS, desc = "speed_descriptions",     group = "hof_meadow_r", order = 7,  world = {"forest"}},
...
--[[
WSO.Pre.wildwheats = function(difficulty)
	local tuning_vars =
	{
