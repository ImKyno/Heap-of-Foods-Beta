...
local function sapling_fn(build, anim, growprefab, tag, fireproof, overrideloot)
    local function fn()
        ...
        inst.AnimState:SetBank("kyno_bananatree_sapling")
        inst.AnimState:SetBuild("kyno_bananatree_sapling")
        inst.AnimState:PlayAnimation("planted")

        inst:AddTag("cattoy")
		inst:AddTag("bananatree_sapling")
        ...
        inst.growprefab = "kyno_bananatree"
...
return Prefab("kyno_bananatree_sapling", sapling_fn("kyno_bananatree_sapling", "planted", "kyno_bananatree", "bananatree", true), pinecone_assets, pinecone_prefabs)