local function ondeploy(inst, pt, deployer)
	local plant = SpawnPrefab("kyno_pineapplebush2")
...
local function make_plantable(data)
    ...
    local function fn()
		...
		inst.components.inventoryitem.imagename = "dug_kyno_pineapplebush"
...
local plantables =
{
	{name = "kyno_pineapplebush", bank = "kyno_pineapplebush", build = "kyno_pineapplebush", mediumspacing = true},
}
