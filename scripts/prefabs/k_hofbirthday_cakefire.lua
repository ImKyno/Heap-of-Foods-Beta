local MakeCakeFire = require("prefabs/k_hofbirthday_cakefire_common")
...
return MakeCakeFire("kyno_hofbirthday_cakefire", assets, nil, common_postinit, master_postinit)