...
local function MakeCakeFire(name, customassets, customprefabs, common_postinit, master_postinit)
    local assets =
	{
		Asset("SCRIPT", "scripts/prefabs/k_hofbirthday_cakefire_common.lua"),
	}
	...
	local function fn()
		...
		inst.SoundEmitter:SetParameter("torch", "intensity", .3)
