local assets =
{
	Asset("ANIM", "anim/swap_malbatross_pouch.zip"),
	Asset("ANIM", "anim/malbatross_pouch.zip"),
...
local function OnHit(inst, attacker, target)
	...
	if not TheWorld.Map:IsOceanAtPoint(x, y, z) then
		SpawnPrefab("kyno_malbatrossfood").Transform:SetPosition(x, y, z)
	else
		SpawnPrefab("splash_green").Transform:SetPosition(x, y, z)
		SpawnPrefab("kyno_malbatross_aoe").Transform:SetPosition(x, y, z)
	end
...
local function fn()
	...
	inst.AnimState:SetBank("malbatross_pouch")
	inst.AnimState:SetBuild("malbatross_pouch")
...
return Prefab("kyno_malbatrossfood", fn, assets, prefabs)