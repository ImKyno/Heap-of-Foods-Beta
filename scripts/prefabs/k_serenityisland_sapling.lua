...
local function sapling_fn(build, anim, growprefab, tag, fireproof, overrideloot)
    local function fn()
        ...
        inst.AnimState:SetBank("kyno_serenityisland_sapling")
        inst.AnimState:SetBuild("kyno_serenityisland_sapling")
        inst.AnimState:PlayAnimation("planted")

        inst:AddTag("cattoy")
		inst:AddTag("kyno_sugartree_sapling")
        ...
        inst.growprefab = "kyno_sugartree_short"
...
return Prefab("kyno_sugartree_sapling", sapling_fn("kyno_serenityisland_sapling", "planted", "kyno_sugartree_short", "sugartree", true), pinecone_assets, pinecone_prefabs)