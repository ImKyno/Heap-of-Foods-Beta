local function OnTick(inst, target)
    if target.components.health ~= nil and
        ...
        target.components.hunger:DoDelta(1, nil, "jellybean")
		target.components.health:DoDelta(1, nil, "jellybean")
		target.components.sanity:DoDelta(1, nil, "jellybean")
    else
...
return Prefab("kyno_waterbuff", fn)