...
{
	ActionHandler(ACTIONS.RUMMAGE, "store"),
	ActionHandler(ACTIONS.TAKEFROMCONTAINER, "pickup"),
	ActionHandler(ACTIONS.STORE, "store"),
	
	ActionHandler(ACTIONS.COOK, "store"),
	ActionHandler(ACTIONS.BREWER, "store"),
}
...
CommonStates.AddWalkStates(states, nil, nil, true, nil,
	{
...
return StateGraph("cook_robot", states, events, "idle", actionhandlers)