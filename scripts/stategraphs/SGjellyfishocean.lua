...
local states = 
{
	State{
		...
		events = 
		{
			EventHandler("animqueueover", function(inst) inst.sg:GoToState(math.random() <= 0.25 and "shock" or "idle") end),
		},
	},
...
return StateGraph("jellyfishocean", states, events, "idle", actionhandlers)