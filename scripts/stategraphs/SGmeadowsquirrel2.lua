...
local states =
{
	...
	State
	{
		...
		timeline =
		{
			TimeEvent(16 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("hof_sounds/creatures/piko/idle") end),
			TimeEvent(18 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("hof_sounds/creatures/piko/idle") end),
			TimeEvent(20 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("hof_sounds/creatures/piko/idle") end),
		},
	...
	State
	{
		...
		timeline =
		{
			...
			TimeEvent(2 * FRAMES, function(inst) inst.SoundEmitter:PlaySound("hof_sounds/creatures/piko/attack") end),
		},
...
return StateGraph("kyno_piko_orange", states, events, "init", actionhandlers)