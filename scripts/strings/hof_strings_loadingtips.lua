...
AddLoadingTip(TIPS_HOF, "TIPS_HOF_CRABTRAP", 		"\"Those rock crabs seems to avoid all of my traps! Perhaps some kind of special trap can work instead?\" -W")
...
AddLoadingTip(TIPS_HOF, "TIPS_HOF_MILKABLEANIMALS", "Some animals such as Beefalos and Koalefants can be milked using a Bucket. But be careful to not get kick!")
...
AddLoadingTip(TIPS_HOF, "TIPS_HOF_COOKWAREBONUS",   "Special Cookware stations have a small chance of giving an extra food when cooking. Cross your fingers and hope that sweet meal comes in double!")
AddLoadingTip(TIPS_HOF, "TIPS_HOF_POISONBUNWICH",   "The Noxious Froggle Bunwich can be quite difficult to cook, but it has an interesting quirk: frogs will be passive towards you for a whole day!")
