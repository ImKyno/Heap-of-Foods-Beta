...
STRINGS.SCRAPBOOK.SPECIALINFO.FOODEFFECTS_INSANITY = "Induces insanity for a short period."
...
STRINGS.SCRAPBOOK.SPECIALINFO.FOODEFFECTS_WURTFOOD = "Monster survivors can eat this food without any penalties.\nWurt will gain extra benefits from eating this food."
...
STRINGS.SCRAPBOOK.SPECIALINFO.FOODEFFECTS_MONSTERFOOD3 = "Monster survivors can eat this food without any penalties.\nBriefly increases the temperature."
...
STRINGS.SCRAPBOOK.SPECIALINFO.FOODEFFECTS_JAWSBREAKER = "Allures and kills Rockjaws and Gnarwails when thrown into the ocean. Does not work if they are too close."
...
STRINGS.SCRAPBOOK.SPECIALINFO.CRABTRAP = "Once set on the ground, it will trigger when a crab moves nearby, capturing them.\n\nCollecting a captured trap will put the creature inside your inventory.\n\nCrab Traps can be baited with meats."
...
STRINGS.SCRAPBOOK.SPECIALINFO.SLAUGHTERTOOL = "Butchering tools that instantly kill the animal."
...
STRINGS.SCRAPBOOK.SPECIALINFO.SPICEPACK_REWORK = "A carryable container with 6 slots that can hold cooking ingredients prepared food.\n\nThe contents stored in it will be preserved for longer."
...
STRINGS.SCRAPBOOK.SPECIALINFO.PINEAPPLEBUSH = "Pineapple Bushes take nearly 6 days to fully grow. They take longer to grow in all seasons except for Summer.\n\nDuring Summer they will start growing every 2 days."
...
STRINGS.SCRAPBOOK.SPECIALINFO.SURFACEBANANATREE = "A rare and elusive exotic tree, capable of growing outside of underground environments.\n\nIt's said to be extinct in nature, only a few of them remain in care of specialized caretakers."
STRINGS.SCRAPBOOK.SPECIALINFO.PARTITIO = "A proud pig merchant who lives in the Deciduous Forest, always eager to trade his goods for valuable items.\n\nDespite his arrogant and competitive attitude, he values honest customers and never misses a chance to make a good deal.\n\nHowever, after some past unfortunate events he refuses to do business with Mermfolk under any circumstances."
STRINGS.SCRAPBOOK.SPECIALINFO.PARTITIOHOUSE = "Partitio's Warehouse sells an array of products. Mostly fruit tree saplings and other kinds of plants."
...
STRINGS.SCRAPBOOK.SPECIALINFO.HOFBIRTHDAY_CAKE = "Can be sliced using a Cleaver to obtain Slice of Anniversary Cake. Each Slice has a different flavor and effect.\n\nIncreases sanity of the survivors around it over time.\n\nCelebrating the 5th Anniversary of Heap of Foods!"
STRINGS.SCRAPBOOK.SPECIALINFO.HOFBIRTHDAY_BALLOONS = "Increases sanity of the survivors around it over time.\n\nCelebrating the 5th Anniversary of Heap of Foods!"
