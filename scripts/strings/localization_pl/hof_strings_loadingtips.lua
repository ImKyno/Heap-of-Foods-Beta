...
local LOADINGTIPS   =
{
	...
	OLDMOD          = "Pierwsza wersja Stos jedzenia nazywała się The Foods Pack i została porzucona z powodu błędów. Później została przerobiona na ten nowy mod.",
	...
	BIRTHDAY5TH     = "Stos jedzenia ma już 5 lat! Dziękujemy za te niesamowite lata. I oby było ich jeszcze więcej!",
	BIRTHDAY_CAKE1  = "Świętuj 5. Rocznicę Stos jedzenia podczas wydarzenia ograniczonego czasowo! Upiecz i złóż ogromny tort, postaw balony i baw się dobrze!",
	...
	BIRTHDAY_CHEER  = "Podczas wydarzenia rocznicowego Stos jedzenia, radość rocznicową można uzyskać poprzez gotowanie, warzenie lub doprawianie potraw, mając na sobie kapelusz rocznicowy.",
	BIRTHDAY_CORN   = "Maszyna do popcornu może wyprodukować 5 pocornów z jednej kukurydzy. A podczas rocznicy Stos jedzenia będzie produkować rocznicowy popcorn.",
