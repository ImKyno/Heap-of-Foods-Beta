...
local LOADINGTIPS   =
{
	...
	INGREDIENTS     = "Existem novos ingredientes do jogo base disponíveis para serem usados na Panela. Até os mais estranhos...",
	...
	OLDMOD          = "A primeira versão do Amontoado de Comidas era chamada The Foods Pack, foi descontinuada devido a erros. Mais tarde, foi recriada neste novo mod.",
	...
	TUNACAN         = "O Atum Enlatado nunca estragará, a menos que seja aberto.",
	...
	BOTTLE_SOUL2    = "Todo sobrevivente pode carregar a Alma Engarrafada no inventário, mas apenas Wortox pode Liberar a Alma.",
	...
	BREWBOOK        = "Receitas feitas no Barril de Madeira ou Jarra de Conservas não aparecerão no Livro de Receitas. Em vez disso, você pode visualizá-las no Livro de Fermentação!",
	PIKOS           = "Cuidado com os Esquilos! Essas pequenas criaturas gostam de roubar comida de presas fáceis.",
	TIDALPOOL       = "A Poça de Maré tem uma variedade de peixes que podem ser pescados durante todas as estações! Certifique-se de trazer sua Vara de Pesca de Água Doce!",
