...
STRINGS.SCRAPBOOK.SPECIALINFO.FOODEFFECTS_NUKACOLA_BRAMBLE = "Cobre o sobrevivente com espinhos, atacantes sofrerão dano em uma pequena área ao atacar o sobrevivente.\n\nReduz brevemente a temperatura."
...
STRINGS.SCRAPBOOK.SPECIALINFO.FOODEFFECTS_THORNS = "Cobre o sobrevivente com espinhos, atacantes sofrerão dano em uma pequena área ao atacar o sobrevivente."
...
STRINGS.SCRAPBOOK.SPECIALINFO.WX78MODULE_DRYER = "Conecta-se à placa de circuito Beta do WX-78. A receita de criação é escaneada de um Cortador de Biscoitos ou Cachorro Salgado.\n\nRequer 2 soquetes e coloca um recipiente de secagem no último slot à direita do inventário de WX-78.\n\nExperimentação com Circuitos Beta II aprimora este circuito, concedendo 50% de resistência à água ao WX-78 e permitindo a produção de Cristais de Sal."
