...
WENDY.DESCRIBE.WEED_SEEDS = "Một cái cây đang chờ được thành hình."
...
WENDY.DESCRIBE.MIDNIGHTFEAST = "Một bữa ăn dùng trong bóng tối cho những việc làm u ám hơn."
...
WENDY.DESCRIBE.KYNO_PIGCOIN1 = "Ta sẽ đặt chúng lên mắt mình khi chết."
WENDY.DESCRIBE.KYNO_PIGCOIN2 = "Tiền cũng không thể mang Abigail trở lại."
WENDY.DESCRIBE.KYNO_PIGCOIN3 = "Sự giàu có không thể mua sự bất tử."
