...
local LOADINGTIPS   =
{
	COFFEE1         = "击败蜻蜓后，你可以获得咖啡植物。或者，如果你觉得太可怕，可以去火山口生物群落拿一些！",
	COFFEE2         = "咖啡植物在夏季不需要施肥。它们甚至会自己施肥！",
	COFFEE3         = "咖啡植物只能种植在沙地或火山口地面上。",
	...
	ITEMSLICER      = "肉块和一些硬质水果可以用切片刀切片。",
	ITEMSLICER_GOLD = "黄金切片刀用途广泛，切削速度比普通切片刀更快。",
	SAMMY1          = "萨米可以在海滨岛上找到，他出售各种稀有物品和原料，这些东西在外面可不容易找到。",
	SAMMY2          = "萨米的货物会随着季节和特殊世界事件的变化而变化。请务必定期查看他的小店，看看他有什么可供挑选的。",
	SAMMY3          = "击败果蝇之王后，你应该去找萨米。他会奖励那些被证明有资格的人一些好奇的物品！",
	...
	BOOKGARDENING1  = "维克博顿的《园艺学，精通》可以种植任何类型的植物，甚至一些你平时无法种植的特殊树木！",
	BOOKGARDENING2  = "维克博顿的《园艺学，精通》有机会将农场植物培育成超大形态！",
	FARMPLOT        = "如果新的农耕系统对你来说太复杂，不用担心！萨米会帮你，他正在出售一些旧的蓝图，会对你有帮助。",
}
