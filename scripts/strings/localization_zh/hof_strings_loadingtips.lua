...
local LOADINGTIPS   =
{
	...
	OLDMOD          = "更多料理 的第一个版本名为食物包，后因错误而停用。后来，它被重新制作成了这个全新的Mod。",
	...
	SALTPOND2       = "人工盐池产生盐结晶的速度比天然盐池慢，且只能建造在岩石地面上。",
	...
	WEBSITE         = "你知道 更多料理 有一个官方网站吗？现在你知道了。在这里学习如何制作所有食谱：https://heap-of-foods.com",
	DAILYRECIPES1   = "每日食谱是每天从食谱池中选出的特色菜。所有玩家共享相同的食谱，与世界无关。每天会随机选择一道食谱。食用每日食谱会在原有属性之外，额外提供生命值、饥饿值和理智值加成。同时还会在一定时间内提升幸运值。",
	DAILYRECIPES2   = "你可以通过建造每日食谱板，或访问模组的官方网站来查看当前的每日食谱。",
	CAVETUBERTREE1  = "洞穴块茎树十分坚固，不会轻易倒下。带上你最好的斧头来砍伐它们吧！",
	CAVETUBERTREE2  = "到了春天，洞穴块茎树会开始开花，并产出另一种洞穴块茎。",
	ELDERMANDRAKE1  = "远古曼德拉草被杀死时，会让周围所有生物沉睡数秒。",
	ELDERMANDRAKE2  = "小心！远古曼德拉草不喜欢你在它们附近携带蔬菜或其他曼德拉草。",
	ELDERMANDRAKE3  = "\"我听说昨天有人在蘑菇森林附近的洞穴里发现了一些奇怪的叶子房屋，不知道是谁住在那里……\" -W",
	ELDERMANDRAKE4  = "成熟的曼德拉草有几率掉落农作物种子和杂草种子，具体取决于季节。",
	EARMUFFSHAT     = "兔耳护耳现在可以提供抵御巨大噪音的保护！",
	PIGCOIN1        = "烹饪食物可以与猪王交换猪币。每种食物都有自己的价值，稀有且优质的食物比普通菜肴更值钱。",
	PIGCOIN2        = "猪王饿了，正在索要食物！他愿意用猪币（据他的追随者所说，这是他最新推出的货币）来交换美味佳肴。",
	PIGCOIN3        = "\"看起来那头蠢猪正想用几枚硬币换食物。也许我能靠他赚上一笔！\" -W",
	PARTITIO1       = "帕提提欧是一只居住在落叶林中的自豪猪人。他只出售高品质商品，并期待结识新的顾客。",
	PARTITIO2       = "经历了一些不幸的往事后，帕提提欧发誓再也不会和鱼人做生意了！",
	PARTITIO3       = "帕提提欧发现有人破坏了他的房子，现在他需要帮助将房屋重建至昔日的辉煌，才能重新开始营业。",
	CRITDAMAGE      = "闪光搅打奶油能让你的攻击触发暴击，造成高达 150% 的额外伤害！",
	RANDOMBUFF      = "闪光棒棒糖食用后会产生随机副作用。你今天运气如何？",
	OPALAPPLE       = "附魔闪耀苹果是击败强大首领后才能获得的稀有物品。它们能在有限时间内赋予无敌效果。",
	WOODCUTTER      = "“活体三明治”能提高砍伐效率，使树木在被砍倒时掉落更多原木，伍迪享受这一增益效果的时间也比其他幸存者更长。"
}
