...
local LOADINGTIPS   =
{
	...
	OCTOPUSTRADER   = "\"Yesterday when sailing, I found a lonely octopus sleeping in a nearby cluster of seastacks. I wonder if he has something useful to trade for.\" -W.",
