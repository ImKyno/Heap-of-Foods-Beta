...
function BrewbookPage:_DoFocusHookups()
...
function BrewbookPage:CreateRecipeBook()
...
function BrewbookPage:_SetupRecipeIngredientDetails(recipes, parent, y)
...
function BrewbookPage:_GetSideEffectString(recipe_def)
...
function BrewbookPage:_sortfn_sideeffects(a, b)
...
function BrewbookPage:ApplyFilters()
